...
```bash
tmux
bash <(wget -qO- https://raw.githubusercontent.com/TotallyNotOver/xray-vps-setup/refs/heads/main/vps-setup.sh)
```
...
Описана [здесь](https://github.com/TotallyNotOver/xray-vps-setup/blob/main/install_in_docker.md).  
...
Sing-box не очень.  
XHTTP уже здесь, а больше не надо.

## Связь
Issues, PR ну или мой [тг](https://t.me/OverLessArtem).
